...
if 'sync_rate' not in st.session_state:
    st.session_state.sync_rate = st.session_state.rom_config.get('escalation_rate', 0.034) * 100
...
if st.session_state.show_rom_settings:
    ...
    with col1:
        ...
        st.session_state.rom_config['escalation_rate'] = st.session_state.sync_rate / 100
    with col2:
...
with col2:
    ...
    st.session_state.rom_config['escalation_rate'] = st.session_state.sync_rate / 100
    annual_increase_rate = st.session_state.sync_rate
